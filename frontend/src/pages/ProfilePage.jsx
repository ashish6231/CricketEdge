...
export default function ProfilePage() {
  ...
  const isPro = user.subscription?.planSlug === 'pro' && user.subscription?.status === 'active'
          ...
          <div>
            ...
            <div className="flex items-center gap-1 mt-1">
              ...
              {isPro
                ...
                : <span className="text-xs font-bold px-2 py-0.5 rounded-full bg-gray-100 text-gray-500">Free</span>
              }
            </div>
          </div>
        </div>
        ...
        {!isPro && (
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="font-semibold text-text-primary">Upgrade to Pro</span>
            </div>
